      ...
      <div className="home-content">
        <div className="home-text fade-in fade-in-1">
          ...
          <p className="home-desc">
            Second-year Software Engineering student at FPT University, seeking
            a Backend Developer Internship. My core competencies include Java
            and TypeScript, with proficiency in SQL Server and MongoDB. Also
            well-prepared as a Fullstack Developer with experience in React.js
            and Next.js.
          </p>
          <button
        ...
        <div className="home-avatar-wrap fade-in fade-in-3">
          <div className="home-avatar-circle">
            <img src="/ava1.jpg" alt="Đặng Đức Dương" />
          </div>
